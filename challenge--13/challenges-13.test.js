...
const firstLetters = (arr) => {
    var answer = arr.map(newStr => newStr.charAt(0));
...
const findHappiness = (arr) => {
    var answer = arr.filter(happyString => happyString.includes(':)'));
    return answer;
};
...
const allHappy = (arr) => {
    var answer = arr.every(string => string.includes(':)'));
    return answer;
};
...
const findAnything = (arr, target) => {
    var answer = arr.filter(strFilter => strFilter.includes(target));
...
const unenrollBrook = (arr) => {
    var answer = arr.map(newArr => {

        var answerArr = newArr.filter(str => {
