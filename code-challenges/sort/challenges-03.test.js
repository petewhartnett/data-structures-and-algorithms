...
// ------------------------------------------------------------------------------------------------ */
// // unction callback(a,b){
// //     if(a>b && a != a.tolowerCase()){
// //         return 1;
// //     }
// //     else{
// //         return -1;
...
//     //n arr = arr.map(function(x){ return x.toLowerCase() });
//  return arr.sort(callBack4);
// };
