...
const returnNames = (arr) => {
  ...
  return arr.reduce((accumulator, information) => accumulator.concat([information.name]), []);
};
...
const reversedString = (str) => {
  ...
  return str.split('').reduce((accumulator, information) => information + accumulator);
...
const countNumberOfChildren = (arr) => {
  ...
  return arr.reduce((accumulator, information) => {

    if(information.children){
      accumulator = accumulator + information.children.length;
    }
    return accumulator;
  }, 0);
};
...
const calculateAverage = (arr) => {
  ...
  return arr.reduce((accumulator,information) => accumulator + information, 0) / arr.length;
};
